  ...
  <React.StrictMode>
    <Router>
      <Routes>
        ...
        <Route path='/dashboard/secretarygeneral/addnote' element={<SecretaryGeneral />} />
        <Route path='/dashboard/secretarygeneral/noteslist' element={<SecretaryGeneral />} />
        <Route path='/dashboard/secretarygeneral/notes/:id' element={<SecretaryGeneral />} />
