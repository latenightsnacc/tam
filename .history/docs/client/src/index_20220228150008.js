  ...
  <React.StrictMode>
    <Router>
      <Routes>
        ...
        <Route path='/api/dashboard/secretarygeneral' element={<SecretaryGeneral />} />
        <Route path='/api/dashboard/secretarygeneral/addnote' element={<AddNote />} />
        <Route path='/api/dashboard/secretarygeneral/notes' element={<NotesList />} />
        <Route path='/api/dashboard/secretarygeneral/notes/:id' element={<Note />} />
        <Route path='/api/dashboard/treasurer' element={<Treasurer />} />
        <Route path='/api/dashboard/president' element={<President />} />
        <Route path='/api/dashboard/coordinator' element={<Coordinator />} />
      </Routes>
    </Router>
  </React.StrictMode>,
