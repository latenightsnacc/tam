...
const App = () => {
  ...
  useEffect(() => {
    ...
    if(user) {
      ...
      setTreasurerDashboard(user.roles.includes("ROLE_TREASURER"));
      setPresidentDashboard(user.roles.includes("ROLE_PRESIDENT"));
      setCoordinatorDashboard(user.roles.includes("ROLE_COORDINATOR));
    }
  })
