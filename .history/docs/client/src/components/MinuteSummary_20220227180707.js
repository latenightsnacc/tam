    ...
    return(
        <div className="container my-4">
            ...
            <div className="absolute -top-2 left-5">
                ...
                <div className="flex text-gray-500 px-2 flex-row mt-4 mb-2 items-center">
                
                    <span className="text-xs font-medium"><span className="text-gray-300 mr-1"><i class="fa-solid fa-user"></i></span>Deborah Egonu</span>
                ...
                <p className="text-gray-700 px-2 leading-7 tracking-wide"><span className="text-gray-300 mr-1"><i class="fa-solid fa-clock"></i></span> {props.text}</p> 
