const MinuteSummary = (props) => {
    return(
        <div className="container my-4">
            <div className="min-w-sm shadow p-2 mt-3 text-xs md:text-sm text-gray-800">
                <div className="flex justify-between my-1 items-center">
                    <span className={`rounded py-2  px-2  capitalize ${props.tagColor} text-gray-800`}>{props.tag}</span>
