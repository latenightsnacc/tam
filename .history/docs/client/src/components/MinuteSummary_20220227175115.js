        ...
        <div className="container my-4">
            <div className="min-w-sm shadow-sm rounded p-2 mt-3 text-xs md:text-sm text-gray-800 hover:shadow-2xl">
                ...
                <div className="flex flex-row my-2">
                    <span className="text-green-500 text-xs"><span className="text-gray-300 mr-1"><i class="fa-solid fa-user"></i></span>Deborah Egonu</span>
                    <span className="text-gray-500 text-xs ml-3"><span className="text-gray-300 mr-1"><i class="fa-solid fa-clock"></i></span>{new Date(props.date)}</span>
                </div>
