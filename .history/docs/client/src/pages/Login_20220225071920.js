          ...
          <div className="flex h-screen items-center justify-center">
              ...
              <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div className="mb-4">
                  ...
                  <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-gren-400" id="username" type="text" placeholder="Email" />
                </div>
                <div className="mb-6">
