          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <span className="text-green-500 font-semibold capitalize">CDS E-attendance</span>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div className={`relative group py-2 mb-4 rounded text-sm w-full shadow-sm border border-1 border-gray-300  appearance-none rounded focus:outline-none focus:shadow-outline focus:border hover:border-2 ${errors.firstname ? 'hover:'} hover:border-green-400`}>
