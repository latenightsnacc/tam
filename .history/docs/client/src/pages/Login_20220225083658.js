            ...
            <span className="text-green-500 font-semibold capitalize">CDS E-attendance</span>
              ...
              <form className="bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div className="mb-6">
                  ...
                  <input className="shadow appearance-none border focus:border-green-400 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password"  />
