              ...
              <form className="bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div className="flex flex-row mb-4">
                    ...
                    <div className="ml-4">
                        ...
                        <input className="shadow appearance-none border rounded w-full mdpy-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-green-400" id="username" type="text" placeholder="Egonu" />
                        <div className="msg mt-2 hidden">
                            <p className="text-red-500 text-xs italic">Please enter your password.</p>
                        </div>
                    </div>
