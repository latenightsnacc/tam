            ...
            <div className="w-full max-w-lg">
              <form className="bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div className="flex w-full flex-col">
                  ...
                  <span className="inline-block mt-2 align-baseline font-bold text-xs text-gray-500  text-center">
                    Already have a profile? 
                    <Link to={"/login"}>
                        <span className="hover:text-green-800 cursor-pointer">Login</span>
                    </Link>
                  </span>
                </div>
              </form>
