                        ...
                        <div className="flex flex-col md:flex-row w-full">
                            <div className="relative border-1 py-2 mb-4 border-gray-300 rounded text-sm w-full hover:border-green-400">
                                <div className="absolute -top-3">
                                    <label className="text-xs px-2 bg-white text-green-500">First Name</label>
                                </div>
                                <Input 
                                type={'text'}
                                name={'firstName'}
                            ...
                            <div className="relative border-1 py-2 mb-4 border-gray-300 rounded text-sm w-full md:w-1/2 hover:border-green-400">
                                <div className="absolute -top-3">
                                    <label className="text-xs px-2 bg-white text-green-500">Last Name</label>
                                </div>
                                <Input 
                                type={'text'}
                                name={'lastName'}
