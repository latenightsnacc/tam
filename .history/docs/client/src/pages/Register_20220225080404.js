              ...
              <form className="bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div className="flex flex-row mb-4">
                    <div className="w-full md:w-1/2 relative">
                        ...
                        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-green-400" id="firstname" type="text" placeholder="Deborah" />
