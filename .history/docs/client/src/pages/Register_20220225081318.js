        ...
        <Container>
          <div className="flex flex-col items-center justify-center">
            ...
            <span className="text-green-500 font-semibold capitalize">CDS E-attendance</span>
              ...
              <div className="relative border border-1  py-2 mb-4 border-gray-300 rounded text-sm w-full hover:border-green-400 shadow appearance-none border rounded focus:outline-none focus:shadow-outline focus:border-green-400">
                            <div className="absolute -top-3">
                            <label className="inline pl-2 bg-white text-gray-700 text-xs font-bold" for="firstname">
                                First Name
                            </label>
                            </div>
                            <input 
                ...
                <div className="flex flex-row mb-4">
                    <div className="w-full md:w-1/2 relative  shadow appearance-none border rounded focus:outline-none focus:shadow-outline focus:border-green-400">
                        ...
                        <input className=" w-full text-gray-700  py-2 px-3 leading-tight " id="firstname" type="text" placeholder="Deborah" />
