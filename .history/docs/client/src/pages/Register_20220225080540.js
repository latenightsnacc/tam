            ...
            <span className="text-green-500 font-semibold capitalize">CDS E-attendance</span>
              ...
              <form className="bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div className="flex flex-row mb-4">
                    <div className="w-full md:w-1/2 relative py-2 px-3  shadow appearance-none border rounded focus:outline-none focus:shadow-outline focus:border-green-400">
                        <div className="absolute">
                            <label className="block text-gray-700 text-sm font-bold" for="firstname">
                                First name
                            </label>
                        </div>
                        <input className=" w-full text-gray-700 leading-tight " id="firstname" type="text" placeholder="Deborah" />
