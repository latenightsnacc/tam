        ...
        <Container>
          <div className="flex flex-col items-center justify-center">
            ...
            <span className="text-green-500 font-semibold capitalize">CDS E-attendance</span>
              ...
              <div className="relative py-2 mb-4 rounded text-sm w-full shadow-sm border border-1 bor  appearance-none rounded focus:outline-none focus:shadow-outline focus:border hover:border-2 hover:border-green-400">
