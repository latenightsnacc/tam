        ...
        <Container>
          <div className="flex flex-col items-center justify-center">
            ...
            <span className="text-green-500 font-semibold capitalize">CDS E-attendance</span>
              ...
              <div className="relative border border-1  py-2 mb-4 border-gray-300 rounded text-sm w-full hover:border-green-400 shadow appearance-none rounded focus:outline-none focus:shadow-outline focus:border-green-400">
                            <div className="absolute -top-3">
                            <label className="inline px-2 bg-white text-gray-700 text-xs font-bold" for="firstname">
                                First Name
                            </label>
                            </div>
                            <input 
                            ...
                            name={'statecode'}
                            value={''}
                            className={'border-0 text-xs md:text-sm w-full text-gray-700  py-2 px-3 leading-tight focus:ring-0 focus:outline-0 text-uppercase'}
                            onChange={''}
                            required />
                        </div>
