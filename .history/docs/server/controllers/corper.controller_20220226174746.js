...
exports.createCorper = (req, res) => {
    try{
        ...
        const img = fs.readFileSync(
            "C:/Users/User/Documents/GitHub/Sites/tam/docs/server\controllers\corper.controller.js/resources/static/assets/uploads/"+req.body.profilePic
        );
        const corper = {
        ...
        .then(data => {
            fs.writeFileSync(
                "../resources/static/assets/tmp/"+ req.body.profilePic, data.profilePic
            );
